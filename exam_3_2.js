...
class ExDate extends Date {
  ...
  timeDiff(oldDate) {
    const diffTime = Math.abs(this - oldDate);
...
console.log(
  // exDate.toDateString("YYYY-MMM-DD HH:mm:ss Is my proof of concept!")
  exDate.timeDiff(new Date("2022-02-21 17:58:00"))
);
